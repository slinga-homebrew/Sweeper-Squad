...
SRCS=main.c assets.c gameplay.c state.c pause.c ssmtf_logo.c team_select.c title_screen.c util.c objects/explosion.c objects/grid.c objects/flag.c objects/player.c
